...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "C:\\xampp\\htdocs\\DrupalWebsite\\themes\\bootstrap\\templates\\input\\input--button.html.twig");
    }
}
